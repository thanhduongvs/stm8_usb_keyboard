 ...
 479  006e 85            	popw	x
 480  006f 81            	ret
 526                     ; 135 void GPIO_Write(GPIO_TypeDef* GPIOx, uint8_t PortVal)
 526                     ; 136 {
 527                     	switch	.text
 528  0070               _GPIO_Write:
 530  0070 89            	pushw	x
 531       00000000      OFST:	set	0
 534                     ; 137     GPIOx->ODR = PortVal;
 ...
 542  0076 85            	popw	x
 543  0077 81            	ret
 590                     ; 148 void GPIO_WriteHigh(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 590                     ; 149 {
 591                     	switch	.text
 592  0078               _GPIO_WriteHigh:
 594  0078 89            	pushw	x
 595       00000000      OFST:	set	0
 598                     ; 150     GPIOx->ODR |= (uint8_t)PortPins;
 600  0079 f6            	ld	a,(x)
 ...
 606  007d 85            	popw	x
 607  007e 81            	ret
 654                     ; 161 void GPIO_WriteLow(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 654                     ; 162 {
 655                     	switch	.text
 656  007f               _GPIO_WriteLow:
 658  007f 89            	pushw	x
 659       00000000      OFST:	set	0
 662                     ; 163     GPIOx->ODR &= (uint8_t)(~PortPins);
 ...
 671  0085 85            	popw	x
 672  0086 81            	ret
 719                     ; 174 void GPIO_WriteReverse(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 719                     ; 175 {
 720                     	switch	.text
 721  0087               _GPIO_WriteReverse:
 723  0087 89            	pushw	x
 724       00000000      OFST:	set	0
 727                     ; 176     GPIOx->ODR ^= (uint8_t)PortPins;
 729  0088 f6            	ld	a,(x)
 ...
 735  008c 85            	popw	x
 736  008d 81            	ret
 774                     ; 185 uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx)
 774                     ; 186 {
 775                     	switch	.text
 776  008e               _GPIO_ReadOutputData:
 780                     ; 187     return ((uint8_t)GPIOx->ODR);
 782  008e f6            	ld	a,(x)
 785  008f 81            	ret
 822                     ; 196 uint8_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx)
 822                     ; 197 {
 823                     	switch	.text
 824  0090               _GPIO_ReadInputData:
 828                     ; 198     return ((uint8_t)GPIOx->IDR);
 830  0090 e601          	ld	a,(1,x)
 833  0092 81            	ret
 901                     ; 207 BitStatus GPIO_ReadInputPin(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
 901                     ; 208 {
 902                     	switch	.text
 903  0093               _GPIO_ReadInputPin:
 905  0093 89            	pushw	x
 906       00000000      OFST:	set	0
 909                     ; 209     return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
 911  0094 e601          	ld	a,(1,x)
 912  0096 1405          	and	a,(OFST+5,sp)
 915  0098 85            	popw	x
 916  0099 81            	ret
 994                     ; 219 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
 994                     ; 220 {
 995                     	switch	.text
 996  009a               _GPIO_ExternalPullUpConfig:
 998  009a 89            	pushw	x
 999       00000000      OFST:	set	0
1002                     ; 222     assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
1004                     ; 223     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1006                     ; 225     if (NewState != DISABLE) /* External Pull-Up Set*/
1008  009b 0d06          	tnz	(OFST+6,sp)
1009  009d 2708          	jreq	L374
1010                     ; 227         GPIOx->CR1 |= (uint8_t)GPIO_Pin;
1012  009f e603          	ld	a,(3,x)
1013  00a1 1a05          	or	a,(OFST+5,sp)
1014  00a3 e703          	ld	(3,x),a
1016  00a5 2009          	jra	L574
1017  00a7               L374:
1018                     ; 230         GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
